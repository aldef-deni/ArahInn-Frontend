...
import {
  ...
  Users, Tag, LogOut, Menu, X, Hotel as HotelIcon, Bell
} from 'lucide-react'
    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <aside className={cn(
        ...
        <div className="flex items-center gap-3 px-4 h-16 border-b border-white/10">
          ...
          {!collapsed && (
            <span className="font-display font-bold text-lg">OTASystem</span>
          )}
        ...
        <div className="p-3 border-t border-white/10">
          ...
          <button onClick={handleLogout}
            className={cn(
              'mt-3 w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-red-300 hover:bg-red-500/20 hover:text-red-200 transition-colors',
      ...
      <div className={cn('flex-1 flex flex-col transition-all duration-300', collapsed ? 'ml-16' : 'ml-60')}>
        ...
        <header className="sticky top-0 z-40 h-16 bg-white border-b flex items-center justify-between px-6 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/" className="px-3 py-1.5 text-sm text-muted-foreground hover:text-foreground border rounded-lg hover:bg-muted transition-colors">
              ← Ke Website
            </Link>
          </div>
        </header>
